                ...
                <div className="space-y-5">
                  ...
                  >
                    <input 
                      ...
                      className="hidden"
                      required={!editHoodie && images.length === 0} 
                    />
                    ...
                    <div className="text-center">
                      <p className="text-xs font-black text-noir dark:text-white uppercase tracking-tight">Drop up to 6 images</p>
                      <p className="text-[9px] font-bold text-noir/30 dark:text-white/30 uppercase tracking-widest mt-0.5">Show different colors and angles</p>
                    </div>
                    {images.length > 0 && (
