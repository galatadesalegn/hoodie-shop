...
const NAV = [
  { href: '/', label: 'Dashboard', icon: <LayoutDashboard size={18} />, exact: true },
...
const SUPER_NAV = [
  { href: '/admins', label: 'Admin Users', icon: <Shield size={18} /> },
  { href: '/security-logs', label: 'Security Logs', icon: <Shield size={18} /> },
];
